Public Class frmPilotsPastFlight
    Private Sub frmPilotsPastFlight_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If drSourceTableCount.Read() Then
                ...
                lblPastMiles.Text = totalFlights.ToString()
            End If
            ...
            lblPastMiles.Text = totalMilesFlown.ToString()
