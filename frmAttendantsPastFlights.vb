Public Class frmAttendantsPastFlights
    Private Sub frmAttendantsPastFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Dim strSelectFlights As String = "SELECT strFlightNumber, dtmFlightDate, dtmTimeofDeparture, dtmTimeOfLanding, intMilesFlown " &
                                             "FROM TFlights " &
                                             "WHERE intFlightID IN (SELECT intFlightID FROM TAttendantFlights WHERE intAttendantID = " & SelectedAttendantID & ") " &
